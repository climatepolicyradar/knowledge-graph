"""
Infrastructure for the labelling librarian static site

This module represents the infrastructure for a lightweight internal service that
provides a static website for monitoring and maintaining labelling quality.
...
app_name = "cpr-knowledge-graph-labelling-librarian"
...
oai = aws.cloudfront.OriginAccessIdentity(
    f"{app_name}-oai",
    comment="OAI for Labelling Librarian static site",
)
