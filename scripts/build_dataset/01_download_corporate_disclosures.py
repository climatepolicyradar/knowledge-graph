"""
Prompt the user to download the corporate_disclosures documents from the Google Drive link.
...
corporate_disclosures_pdf_dir = raw_data_dir / "pdfs" / "corporate_disclosures"
...
console.print(
    f"📥 Please download the corporate_disclosures documents from the following link: {drive_url}"
)
console.print(
