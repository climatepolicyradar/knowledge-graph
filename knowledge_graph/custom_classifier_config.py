    ...
    class LLMClassifierConfig(BaseModel):
        ...
        def _placeholders_match_related(self):
            ...
            slots = (
                {
                    n
                    for _, n, _, _ in string.Formatter().parse(
        ...
        def render_guidelines(self, definitions: dict[WikibaseID, str]) -> str | None:
        ...
        def to_classifier_kwargs(
            ...
            return {
                ...
                "system_prompt_template": LLMClassifierPrompt(
                    ...
                    labelling_guidelines=self.render_guidelines(definitions or {}),
                ),
            }
