...
def run_sampling(
    ...
    # `LabelledPassage.id` is generated by `Identifier.generate(text)`
    # (labelled_passage.py), and is also derived by extend_dataset.py as passages have
    # no consistent unique identifier of their own.
