...
class Config(BaseModel):
    ...
    skip_existing_aggregation_results: bool = Field(
        default=True,
        description="Skip documents that already have aggregation results in S3. Set to `False` to force re-processing.",
    )
    ...
    def to_json(self) -> dict:
        ...
        return {
            ...
            "skip_existing_aggregation_results": self.skip_existing_aggregation_results,
        }
