...
def group_inference_results_into_states(
    ...
    successes: dict[str, BatchInferenceResult] = {}
...
async def inference(
    ...
    success_classifier_specs = [
        spec for spec in classifier_specs if str(spec) in successes.keys()
    ]
    failures_classifier_specs = [
        spec for spec in classifier_specs if str(spec) not in successes.keys()
    ]
