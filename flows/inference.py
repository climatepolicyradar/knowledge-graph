...
def serialise_labels(labels: Sequence[LabelledPassage]) -> BytesIO:
    """Serialize labelled passages as JSONL format."""
    return serialise_pydantic_list_as_jsonl(labels)
...
async def store_labels(
    ...
    async def fn(inference) -> PutObjectOutputTypeDef:
        ...
        body = serialise_labels(inference.labelled_passages)
